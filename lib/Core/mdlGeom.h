...
DPoint3d* mdlGeom_pobierzPunkty (MSElementDescr* edP, NumerPlikuDgn filenum, int* nPunktyP);
DPoint3d* mdlGeom_pobierzPunktyKompleksu (MSElementDescr* edP, NumerPlikuDgn filenum, int* nPunktyP);
int mdlGeom_obliczPunktyKompleksu (MSElementDescr* edP, NumerPlikuDgn filenum, int* nPunktyP);
DPoint3d* mdlGeom_pobierzPunktyWszystkie (MSElementDescr* edP, NumerPlikuDgn filenum, int* nPunktyP);
